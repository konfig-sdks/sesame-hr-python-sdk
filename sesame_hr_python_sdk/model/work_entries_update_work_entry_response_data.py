...
class WorkEntriesUpdateWorkEntryResponseData(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def employee() -> typing.Type['WorkEntriesUpdateWorkEntryResponseDataEmployee']:
                return WorkEntriesUpdateWorkEntryResponseDataEmployee
            workEntryType = schemas.StrSchema
        
            @staticmethod
            def workEntryIn() -> typing.Type['WorkEntriesUpdateWorkEntryResponseDataWorkEntryIn']:
                return WorkEntriesUpdateWorkEntryResponseDataWorkEntryIn
        
            @staticmethod
            def workEntryOut() -> typing.Type['WorkEntriesUpdateWorkEntryResponseDataWorkEntryOut']:
                return WorkEntriesUpdateWorkEntryResponseDataWorkEntryOut
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["employee"]) -> 'WorkEntriesUpdateWorkEntryResponseDataEmployee': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["workEntryType"]) -> MetaOapg.properties.workEntryType: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["workEntryIn"]) -> 'WorkEntriesUpdateWorkEntryResponseDataWorkEntryIn': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["workEntryOut"]) -> 'WorkEntriesUpdateWorkEntryResponseDataWorkEntryOut': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["employee"]) -> typing.Union['WorkEntriesUpdateWorkEntryResponseDataEmployee', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["workEntryIn"]) -> typing.Union['WorkEntriesUpdateWorkEntryResponseDataWorkEntryIn', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["workEntryOut"]) -> typing.Union['WorkEntriesUpdateWorkEntryResponseDataWorkEntryOut', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        employee: typing.Union['WorkEntriesUpdateWorkEntryResponseDataEmployee', schemas.Unset] = schemas.unset,
        workEntryType: typing.Union[MetaOapg.properties.workEntryType, str, schemas.Unset] = schemas.unset,
        workEntryIn: typing.Union['WorkEntriesUpdateWorkEntryResponseDataWorkEntryIn', schemas.Unset] = schemas.unset,
        workEntryOut: typing.Union['WorkEntriesUpdateWorkEntryResponseDataWorkEntryOut', schemas.Unset] = schemas.unset,
