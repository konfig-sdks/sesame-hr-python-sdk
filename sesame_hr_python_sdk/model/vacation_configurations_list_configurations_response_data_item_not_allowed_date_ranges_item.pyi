...
class VacationConfigurationsListConfigurationsResponseDataItemNotAllowedDateRangesItem(
    schemas.DictSchema
):
    """
    ...
    ) -> 'VacationConfigurationsListConfigurationsResponseDataItemNotAllowedDateRangesItem':
