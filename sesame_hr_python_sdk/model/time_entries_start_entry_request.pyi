...
class TimeEntriesStartEntryRequest(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def tagIds() -> typing.Type['TimeEntriesStartEntryRequestTagIds']:
                return TimeEntriesStartEntryRequestTagIds
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["tagIds"]) -> 'TimeEntriesStartEntryRequestTagIds': ...
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["employeeId", "projectId", "tagIds", "comment", "coordinates", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["tagIds"]) -> typing.Union['TimeEntriesStartEntryRequestTagIds', schemas.Unset]: ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["employeeId", "projectId", "tagIds", "comment", "coordinates", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        tagIds: typing.Union['TimeEntriesStartEntryRequestTagIds', schemas.Unset] = schemas.unset,
