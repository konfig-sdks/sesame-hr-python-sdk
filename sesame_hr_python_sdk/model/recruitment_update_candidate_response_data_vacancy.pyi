...
class RecruitmentUpdateCandidateResponseDataVacancy(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def locationVacancy() -> typing.Type['RecruitmentUpdateCandidateResponseDataVacancyLocationVacancy']:
                return RecruitmentUpdateCandidateResponseDataVacancyLocationVacancy
        
            @staticmethod
            def scheduleType() -> typing.Type['RecruitmentUpdateCandidateResponseDataVacancyScheduleType']:
                return RecruitmentUpdateCandidateResponseDataVacancyScheduleType
        
            @staticmethod
            def category() -> typing.Type['RecruitmentUpdateCandidateResponseDataVacancyCategory']:
                return RecruitmentUpdateCandidateResponseDataVacancyCategory
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["locationVacancy"]) -> 'RecruitmentUpdateCandidateResponseDataVacancyLocationVacancy': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["scheduleType"]) -> 'RecruitmentUpdateCandidateResponseDataVacancyScheduleType': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["category"]) -> 'RecruitmentUpdateCandidateResponseDataVacancyCategory': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["locationVacancy"]) -> typing.Union['RecruitmentUpdateCandidateResponseDataVacancyLocationVacancy', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["scheduleType"]) -> typing.Union['RecruitmentUpdateCandidateResponseDataVacancyScheduleType', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["category"]) -> typing.Union['RecruitmentUpdateCandidateResponseDataVacancyCategory', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        locationVacancy: typing.Union['RecruitmentUpdateCandidateResponseDataVacancyLocationVacancy', schemas.Unset] = schemas.unset,
        scheduleType: typing.Union['RecruitmentUpdateCandidateResponseDataVacancyScheduleType', schemas.Unset] = schemas.unset,
        category: typing.Union['RecruitmentUpdateCandidateResponseDataVacancyCategory', schemas.Unset] = schemas.unset,
