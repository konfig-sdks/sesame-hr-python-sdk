...
class WorkEntriesEndLastEntryResponseData(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def employee() -> typing.Type['WorkEntriesEndLastEntryResponseDataEmployee']:
                return WorkEntriesEndLastEntryResponseDataEmployee
            workEntryType = schemas.StrSchema
        
            @staticmethod
            def workEntryIn() -> typing.Type['WorkEntriesEndLastEntryResponseDataWorkEntryIn']:
                return WorkEntriesEndLastEntryResponseDataWorkEntryIn
        
            @staticmethod
            def workEntryOut() -> typing.Type['WorkEntriesEndLastEntryResponseDataWorkEntryOut']:
                return WorkEntriesEndLastEntryResponseDataWorkEntryOut
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["employee"]) -> 'WorkEntriesEndLastEntryResponseDataEmployee': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["workEntryType"]) -> MetaOapg.properties.workEntryType: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["workEntryIn"]) -> 'WorkEntriesEndLastEntryResponseDataWorkEntryIn': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["workEntryOut"]) -> 'WorkEntriesEndLastEntryResponseDataWorkEntryOut': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["employee"]) -> typing.Union['WorkEntriesEndLastEntryResponseDataEmployee', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["workEntryIn"]) -> typing.Union['WorkEntriesEndLastEntryResponseDataWorkEntryIn', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["workEntryOut"]) -> typing.Union['WorkEntriesEndLastEntryResponseDataWorkEntryOut', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        employee: typing.Union['WorkEntriesEndLastEntryResponseDataEmployee', schemas.Unset] = schemas.unset,
        workEntryType: typing.Union[MetaOapg.properties.workEntryType, str, schemas.Unset] = schemas.unset,
        workEntryIn: typing.Union['WorkEntriesEndLastEntryResponseDataWorkEntryIn', schemas.Unset] = schemas.unset,
        workEntryOut: typing.Union['WorkEntriesEndLastEntryResponseDataWorkEntryOut', schemas.Unset] = schemas.unset,
