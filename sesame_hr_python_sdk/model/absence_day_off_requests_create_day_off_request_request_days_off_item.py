...
class AbsenceDayOffRequestsCreateDayOffRequestRequestDaysOffItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["date", "startTime", "endTime", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["date", "startTime", "endTime", ], str]):
    ...
    ) -> 'AbsenceDayOffRequestsCreateDayOffRequestRequestDaysOffItem':
