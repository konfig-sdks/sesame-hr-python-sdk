...
class WorkEntriesListResponseDataItem(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def employee() -> typing.Type['WorkEntriesListResponseDataItemEmployee']:
                return WorkEntriesListResponseDataItemEmployee
            workEntryType = schemas.StrSchema
        
            @staticmethod
            def workEntryIn() -> typing.Type['WorkEntriesListResponseDataItemWorkEntryIn']:
                return WorkEntriesListResponseDataItemWorkEntryIn
        
            @staticmethod
            def workEntryOut() -> typing.Type['WorkEntriesListResponseDataItemWorkEntryOut']:
                return WorkEntriesListResponseDataItemWorkEntryOut
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["employee"]) -> 'WorkEntriesListResponseDataItemEmployee': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["workEntryType"]) -> MetaOapg.properties.workEntryType: ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["workEntryIn"]) -> 'WorkEntriesListResponseDataItemWorkEntryIn': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["workEntryOut"]) -> 'WorkEntriesListResponseDataItemWorkEntryOut': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["employee"]) -> typing.Union['WorkEntriesListResponseDataItemEmployee', schemas.Unset]: ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["workEntryIn"]) -> typing.Union['WorkEntriesListResponseDataItemWorkEntryIn', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["workEntryOut"]) -> typing.Union['WorkEntriesListResponseDataItemWorkEntryOut', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        employee: typing.Union['WorkEntriesListResponseDataItemEmployee', schemas.Unset] = schemas.unset,
        workEntryType: typing.Union[MetaOapg.properties.workEntryType, str, schemas.Unset] = schemas.unset,
        workEntryIn: typing.Union['WorkEntriesListResponseDataItemWorkEntryIn', schemas.Unset] = schemas.unset,
        workEntryOut: typing.Union['WorkEntriesListResponseDataItemWorkEntryOut', schemas.Unset] = schemas.unset,
    ...
    ) -> 'WorkEntriesListResponseDataItem':
