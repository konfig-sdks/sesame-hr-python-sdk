...
class AbsenceDayOffRequestsListDayOffRequestsResponseDataItemAbsenceCalendarEmployeeCompany(
    schemas.DictSchema
):
    """
    ...
    ) -> 'AbsenceDayOffRequestsListDayOffRequestsResponseDataItemAbsenceCalendarEmployeeCompany':
