...
class VacationDayOffListResponseDataItemCalendarVacationConfigurationNotAllowedDateRangesItem(
    schemas.DictSchema
):
    """
    ...
    ) -> 'VacationDayOffListResponseDataItemCalendarVacationConfigurationNotAllowedDateRangesItem':
