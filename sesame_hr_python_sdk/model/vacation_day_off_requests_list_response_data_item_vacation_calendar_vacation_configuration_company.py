...
class VacationDayOffRequestsListResponseDataItemVacationCalendarVacationConfigurationCompany(
    schemas.DictSchema
):
    """
    ...
    ) -> 'VacationDayOffRequestsListResponseDataItemVacationCalendarVacationConfigurationCompany':
