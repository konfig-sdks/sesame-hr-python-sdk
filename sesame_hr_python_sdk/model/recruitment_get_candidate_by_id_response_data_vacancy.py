...
class RecruitmentGetCandidateByIdResponseDataVacancy(
    schemas.DictSchema
):
    """
    ...
    class MetaOapg:
        ...
        class properties:
            ...
            @staticmethod
            def locationVacancy() -> typing.Type['RecruitmentGetCandidateByIdResponseDataVacancyLocationVacancy']:
                return RecruitmentGetCandidateByIdResponseDataVacancyLocationVacancy
        
            @staticmethod
            def scheduleType() -> typing.Type['RecruitmentGetCandidateByIdResponseDataVacancyScheduleType']:
                return RecruitmentGetCandidateByIdResponseDataVacancyScheduleType
        
            @staticmethod
            def category() -> typing.Type['RecruitmentGetCandidateByIdResponseDataVacancyCategory']:
                return RecruitmentGetCandidateByIdResponseDataVacancyCategory
            __annotations__ = {
    ...
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["locationVacancy"]) -> 'RecruitmentGetCandidateByIdResponseDataVacancyLocationVacancy': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["scheduleType"]) -> 'RecruitmentGetCandidateByIdResponseDataVacancyScheduleType': ...
    
    @typing.overload
    def __getitem__(self, name: typing_extensions.Literal["category"]) -> 'RecruitmentGetCandidateByIdResponseDataVacancyCategory': ...
    ...
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["locationVacancy"]) -> typing.Union['RecruitmentGetCandidateByIdResponseDataVacancyLocationVacancy', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["scheduleType"]) -> typing.Union['RecruitmentGetCandidateByIdResponseDataVacancyScheduleType', schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["category"]) -> typing.Union['RecruitmentGetCandidateByIdResponseDataVacancyCategory', schemas.Unset]: ...
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        locationVacancy: typing.Union['RecruitmentGetCandidateByIdResponseDataVacancyLocationVacancy', schemas.Unset] = schemas.unset,
        scheduleType: typing.Union['RecruitmentGetCandidateByIdResponseDataVacancyScheduleType', schemas.Unset] = schemas.unset,
        category: typing.Union['RecruitmentGetCandidateByIdResponseDataVacancyCategory', schemas.Unset] = schemas.unset,
