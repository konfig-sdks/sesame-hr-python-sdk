...
class ProjectsUpdateProjectByIdRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["name", "description", "parentProjectId", "customerId", "price", "startDate", "endDate", "managerId", "status", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["name", "description", "parentProjectId", "customerId", "price", "startDate", "endDate", "managerId", "status", ], str]):
