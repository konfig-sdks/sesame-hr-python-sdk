...
class AbsenceDayOffRequestsListDayOffRequestsResponseDataItemAbsenceCalendarDaysOffItem(
    schemas.DictSchema
):
    """
    ...
    ) -> 'AbsenceDayOffRequestsListDayOffRequestsResponseDataItemAbsenceCalendarDaysOffItem':
