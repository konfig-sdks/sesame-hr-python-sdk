...
class AbsenceDayOffRequestsCreateDayOffRequestResponseDataAbsenceCalendarDaysOffItem(
    schemas.DictSchema
):
    """
    ...
    ) -> 'AbsenceDayOffRequestsCreateDayOffRequestResponseDataAbsenceCalendarDaysOffItem':
