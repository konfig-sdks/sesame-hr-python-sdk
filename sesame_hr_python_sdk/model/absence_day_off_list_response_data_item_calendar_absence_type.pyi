...
class AbsenceDayOffListResponseDataItemCalendarAbsenceType(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "name", "needsValidation", "createdAt", "updatedAt", "createdBy", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "name", "needsValidation", "createdAt", "updatedAt", "createdBy", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        createdBy: typing.Union[MetaOapg.properties.createdBy, None, str, uuid.UUID, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'AbsenceDayOffListResponseDataItemCalendarAbsenceType':
        return super().__new__(
            cls,
            *args,
            id=id,
