...
class ContractsUpdateContractRequest(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["startAt", "code", "endAt", "comment", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["startAt", "code", "endAt", "comment", ], str]):
