...
class VacationCalendarsUpdateCalendarResponseDataVacationConfigurationNotAllowedDateRangesItem(
    schemas.DictSchema
):
    """
    ...
    ) -> 'VacationCalendarsUpdateCalendarResponseDataVacationConfigurationNotAllowedDateRangesItem':
