...
class EmployeeDepartmentAssignationsAssignDepartmentToEmployeeResponseDataEmployeeCustomFieldsItem(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "companyId", "name", "slug", "type", "value", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "companyId", "name", "slug", "type", "value", ], str]):
    ...
    def __new__(
        ...
        *args: typing.Union[dict, frozendict.frozendict, ],
        ...
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
    ) -> 'EmployeeDepartmentAssignationsAssignDepartmentToEmployeeResponseDataEmployeeCustomFieldsItem':
        return super().__new__(
            cls,
            *args,
            id=id,
