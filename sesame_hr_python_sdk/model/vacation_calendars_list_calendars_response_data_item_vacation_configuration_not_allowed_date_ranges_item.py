...
class VacationCalendarsListCalendarsResponseDataItemVacationConfigurationNotAllowedDateRangesItem(
    schemas.DictSchema
):
    """
    ...
    ) -> 'VacationCalendarsListCalendarsResponseDataItemVacationConfigurationNotAllowedDateRangesItem':
