...
class AbsenceDayOffRequestsAcceptRequestResponseDataAbsenceCalendarDaysOffItem(
    schemas.DictSchema
):
    """
    ...
    ) -> 'AbsenceDayOffRequestsAcceptRequestResponseDataAbsenceCalendarDaysOffItem':
