...
class VacationDayOffRequestsListResponseDataItemVacationCalendarEmployeeCompany(
    schemas.DictSchema
):
    """
    ...
    ) -> 'VacationDayOffRequestsListResponseDataItemVacationCalendarEmployeeCompany':
