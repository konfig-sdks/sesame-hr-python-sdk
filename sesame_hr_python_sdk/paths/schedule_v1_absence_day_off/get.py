...
from sesame_hr_python_sdk.model.absence_day_off_list_response import AbsenceDayOffListResponse as AbsenceDayOffListResponseSchema

from sesame_hr_python_sdk.type.absence_day_off_list_response import AbsenceDayOffListResponse

from ...api_client import Dictionary
from sesame_hr_python_sdk.pydantic.absence_day_off_list_response import AbsenceDayOffListResponse as AbsenceDayOffListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = AbsenceDayOffListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: AbsenceDayOffListResponse
    ...
    async def _alist_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/schedule/v1/absence-day-off',
            auth_settings=_auth,
            headers=_headers,
        )
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> AbsenceDayOffListResponsePydantic:
        ...
        if validate:
            return AbsenceDayOffListResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(AbsenceDayOffListResponsePydantic, raw_response.body)
