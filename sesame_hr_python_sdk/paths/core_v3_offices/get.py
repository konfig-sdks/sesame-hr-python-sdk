...
from sesame_hr_python_sdk.model.offices_get_all_response import OfficesGetAllResponse as OfficesGetAllResponseSchema

from sesame_hr_python_sdk.type.offices_get_all_response import OfficesGetAllResponse

from ...api_client import Dictionary
from sesame_hr_python_sdk.pydantic.offices_get_all_response import OfficesGetAllResponse as OfficesGetAllResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = OfficesGetAllResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: OfficesGetAllResponse
...
class GetAll(BaseApi):
    ...
    async def aget_all(
        ...
        **kwargs,
        ...
        if validate:
            return OfficesGetAllResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(OfficesGetAllResponsePydantic, raw_response.body)
