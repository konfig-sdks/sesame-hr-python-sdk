...
from sesame_hr_python_sdk.model.holidays_list_response import HolidaysListResponse as HolidaysListResponseSchema

from sesame_hr_python_sdk.type.holidays_list_response import HolidaysListResponse

from ...api_client import Dictionary
from sesame_hr_python_sdk.pydantic.holidays_list_response import HolidaysListResponse as HolidaysListResponsePydantic
...
SchemaFor200ResponseBodyApplicationJson = HolidaysListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: HolidaysListResponse
    ...
    async def _alist_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/schedule/v1/holidays',
            auth_settings=_auth,
            headers=_headers,
        )
...
class List(BaseApi):
    ...
    async def alist(
        ...
        **kwargs,
        ...
        if validate:
            return HolidaysListResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(HolidaysListResponsePydantic, raw_response.body)
