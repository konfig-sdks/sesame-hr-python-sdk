...
from sesame_hr_python_sdk.model.time_entries_list_response import TimeEntriesListResponse as TimeEntriesListResponseSchema

from sesame_hr_python_sdk.type.time_entries_list_response import TimeEntriesListResponse

from ...api_client import Dictionary
from sesame_hr_python_sdk.pydantic.time_entries_list_response import TimeEntriesListResponse as TimeEntriesListResponsePydantic
...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    'RequestOptionalQueryParams',
    {
        ...
        'employeeStatus': typing.Union[EmployeeStatusSchema, str, ],
...
request_query_employee_status = api_client.QueryParameter(
    name="employeeStatus",
    style=api_client.ParameterStyle.FORM,
...
SchemaFor200ResponseBodyApplicationJson = TimeEntriesListResponseSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: TimeEntriesListResponse
...
class BaseApi(api_client.Api):
    ...
    def _list_mapped_args(
        ...
        if employee_status is not None:
            _query_params["employeeStatus"] = employee_status
...
class List(BaseApi):
    ...
    async def alist(
        ...
        validate: bool = False,
        **kwargs,
    ) -> TimeEntriesListResponsePydantic:
        ...
        if validate:
            return TimeEntriesListResponsePydantic(**raw_response.body)
        return api_client.construct_model_instance(TimeEntriesListResponsePydantic, raw_response.body)
