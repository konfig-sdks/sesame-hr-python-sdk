...
from sesame_hr_python_sdk.pydantic.employees_create_new_employee_response_data_company import EmployeesCreateNewEmployeeResponseDataCompany
from sesame_hr_python_sdk.pydantic.employees_create_new_employee_response_data_custom_fields import EmployeesCreateNewEmployeeResponseDataCustomFields

class EmployeesCreateNewEmployeeResponseData(BaseModel):
    ...
    company: typing.Optional[EmployeesCreateNewEmployeeResponseDataCompany] = Field(None, alias='company')
    ...
    custom_fields: typing.Optional[EmployeesCreateNewEmployeeResponseDataCustomFields] = Field(None, alias='customFields')
