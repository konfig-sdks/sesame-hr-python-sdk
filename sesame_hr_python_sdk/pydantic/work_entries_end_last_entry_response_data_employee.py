...
from sesame_hr_python_sdk.pydantic.work_entries_end_last_entry_response_data_employee_company import WorkEntriesEndLastEntryResponseDataEmployeeCompany
from sesame_hr_python_sdk.pydantic.work_entries_end_last_entry_response_data_employee_custom_fields import WorkEntriesEndLastEntryResponseDataEmployeeCustomFields

class WorkEntriesEndLastEntryResponseDataEmployee(BaseModel):
    ...
    company: typing.Optional[WorkEntriesEndLastEntryResponseDataEmployeeCompany] = Field(None, alias='company')
    ...
    custom_fields: typing.Optional[WorkEntriesEndLastEntryResponseDataEmployeeCustomFields] = Field(None, alias='customFields')
