...
from sesame_hr_python_sdk.pydantic.employees_list_response_data_item_company import EmployeesListResponseDataItemCompany
from sesame_hr_python_sdk.pydantic.employees_list_response_data_item_custom_fields import EmployeesListResponseDataItemCustomFields

class EmployeesListResponseDataItem(BaseModel):
    ...
    company: typing.Optional[EmployeesListResponseDataItemCompany] = Field(None, alias='company')
    ...
    custom_fields: typing.Optional[EmployeesListResponseDataItemCustomFields] = Field(None, alias='customFields')
