...
from sesame_hr_python_sdk.pydantic.core_v3_employee_company import CoreV3EmployeeCompany
from sesame_hr_python_sdk.pydantic.core_v3_employee_custom_fields import CoreV3EmployeeCustomFields

class CoreV3Employee(BaseModel):
    ...
    company: typing.Optional[CoreV3EmployeeCompany] = Field(None, alias='company')
    ...
    custom_fields: typing.Optional[CoreV3EmployeeCustomFields] = Field(None, alias='customFields')
