...
from sesame_hr_python_sdk.pydantic.recruitment_get_candidate_by_id_response_data_status import RecruitmentGetCandidateByIdResponseDataStatus
from sesame_hr_python_sdk.pydantic.recruitment_get_candidate_by_id_response_data_vacancy import RecruitmentGetCandidateByIdResponseDataVacancy

class RecruitmentGetCandidateByIdResponseData(BaseModel):
    id: typing.Optional[str] = Field(None, alias='id')

    company_id: typing.Optional[str] = Field(None, alias='companyId')

    vacancy: typing.Optional[RecruitmentGetCandidateByIdResponseDataVacancy] = Field(None, alias='vacancy')
    ...
    status: typing.Optional[RecruitmentGetCandidateByIdResponseDataStatus] = Field(None, alias='status')
