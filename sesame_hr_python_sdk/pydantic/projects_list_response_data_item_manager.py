...
from sesame_hr_python_sdk.pydantic.projects_list_response_data_item_manager_company import ProjectsListResponseDataItemManagerCompany
from sesame_hr_python_sdk.pydantic.projects_list_response_data_item_manager_custom_fields import ProjectsListResponseDataItemManagerCustomFields

class ProjectsListResponseDataItemManager(BaseModel):
    ...
    company: typing.Optional[ProjectsListResponseDataItemManagerCompany] = Field(None, alias='company')
    ...
    custom_fields: typing.Optional[ProjectsListResponseDataItemManagerCustomFields] = Field(None, alias='customFields')
