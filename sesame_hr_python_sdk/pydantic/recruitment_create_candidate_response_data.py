...
from sesame_hr_python_sdk.pydantic.recruitment_create_candidate_response_data_status import RecruitmentCreateCandidateResponseDataStatus
from sesame_hr_python_sdk.pydantic.recruitment_create_candidate_response_data_vacancy import RecruitmentCreateCandidateResponseDataVacancy

class RecruitmentCreateCandidateResponseData(BaseModel):
    id: typing.Optional[str] = Field(None, alias='id')

    company_id: typing.Optional[str] = Field(None, alias='companyId')

    vacancy: typing.Optional[RecruitmentCreateCandidateResponseDataVacancy] = Field(None, alias='vacancy')
    ...
    status: typing.Optional[RecruitmentCreateCandidateResponseDataStatus] = Field(None, alias='status')
