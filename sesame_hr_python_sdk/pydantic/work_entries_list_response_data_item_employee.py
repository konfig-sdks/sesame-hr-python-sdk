...
from sesame_hr_python_sdk.pydantic.work_entries_list_response_data_item_employee_company import WorkEntriesListResponseDataItemEmployeeCompany
from sesame_hr_python_sdk.pydantic.work_entries_list_response_data_item_employee_custom_fields import WorkEntriesListResponseDataItemEmployeeCustomFields

class WorkEntriesListResponseDataItemEmployee(BaseModel):
    ...
    company: typing.Optional[WorkEntriesListResponseDataItemEmployeeCompany] = Field(None, alias='company')
    ...
    custom_fields: typing.Optional[WorkEntriesListResponseDataItemEmployeeCustomFields] = Field(None, alias='customFields')
