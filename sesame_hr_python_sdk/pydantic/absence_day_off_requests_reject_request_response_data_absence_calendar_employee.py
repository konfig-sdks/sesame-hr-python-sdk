...
from sesame_hr_python_sdk.pydantic.absence_day_off_requests_reject_request_response_data_absence_calendar_employee_company import AbsenceDayOffRequestsRejectRequestResponseDataAbsenceCalendarEmployeeCompany
from sesame_hr_python_sdk.pydantic.absence_day_off_requests_reject_request_response_data_absence_calendar_employee_custom_fields import AbsenceDayOffRequestsRejectRequestResponseDataAbsenceCalendarEmployeeCustomFields

class AbsenceDayOffRequestsRejectRequestResponseDataAbsenceCalendarEmployee(BaseModel):
    ...
    company: typing.Optional[AbsenceDayOffRequestsRejectRequestResponseDataAbsenceCalendarEmployeeCompany] = Field(None, alias='company')
    ...
    custom_fields: typing.Optional[AbsenceDayOffRequestsRejectRequestResponseDataAbsenceCalendarEmployeeCustomFields] = Field(None, alias='customFields')
