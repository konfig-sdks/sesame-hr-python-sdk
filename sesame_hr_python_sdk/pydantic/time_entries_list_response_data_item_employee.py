...
from sesame_hr_python_sdk.pydantic.time_entries_list_response_data_item_employee_company import TimeEntriesListResponseDataItemEmployeeCompany
from sesame_hr_python_sdk.pydantic.time_entries_list_response_data_item_employee_custom_fields import TimeEntriesListResponseDataItemEmployeeCustomFields

class TimeEntriesListResponseDataItemEmployee(BaseModel):
    ...
    company: typing.Optional[TimeEntriesListResponseDataItemEmployeeCompany] = Field(None, alias='company')
    ...
    custom_fields: typing.Optional[TimeEntriesListResponseDataItemEmployeeCustomFields] = Field(None, alias='customFields')
