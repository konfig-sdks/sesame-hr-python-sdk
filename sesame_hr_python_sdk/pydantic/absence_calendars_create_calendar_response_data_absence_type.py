...
from sesame_hr_python_sdk.pydantic.absence_calendars_create_calendar_response_data_absence_type_company import AbsenceCalendarsCreateCalendarResponseDataAbsenceTypeCompany

class AbsenceCalendarsCreateCalendarResponseDataAbsenceType(BaseModel):
    ...
    company: typing.Optional[AbsenceCalendarsCreateCalendarResponseDataAbsenceTypeCompany] = Field(None, alias='company')
