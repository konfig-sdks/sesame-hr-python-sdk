...
from sesame_hr_python_sdk.pydantic.absence_calendars_update_by_id_response_data_absence_type_company import AbsenceCalendarsUpdateByIdResponseDataAbsenceTypeCompany

class AbsenceCalendarsUpdateByIdResponseDataAbsenceType(BaseModel):
    ...
    company: typing.Optional[AbsenceCalendarsUpdateByIdResponseDataAbsenceTypeCompany] = Field(None, alias='company')
