...
from sesame_hr_python_sdk.pydantic.employees_get_by_id_response_data_company import EmployeesGetByIdResponseDataCompany
from sesame_hr_python_sdk.pydantic.employees_get_by_id_response_data_custom_fields import EmployeesGetByIdResponseDataCustomFields

class EmployeesGetByIdResponseData(BaseModel):
    ...
    company: typing.Optional[EmployeesGetByIdResponseDataCompany] = Field(None, alias='company')
    ...
    custom_fields: typing.Optional[EmployeesGetByIdResponseDataCustomFields] = Field(None, alias='customFields')
