...
from sesame_hr_python_sdk.pydantic.absence_types_list_response_data_item_company import AbsenceTypesListResponseDataItemCompany

class AbsenceTypesListResponseDataItem(BaseModel):
    ...
    company: typing.Optional[AbsenceTypesListResponseDataItemCompany] = Field(None, alias='company')
