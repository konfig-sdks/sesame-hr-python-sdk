...
from sesame_hr_python_sdk.pydantic.employee_managers_assign_response_data_manager_company import EmployeeManagersAssignResponseDataManagerCompany
from sesame_hr_python_sdk.pydantic.employee_managers_assign_response_data_manager_custom_fields import EmployeeManagersAssignResponseDataManagerCustomFields

class EmployeeManagersAssignResponseDataManager(BaseModel):
    ...
    company: typing.Optional[EmployeeManagersAssignResponseDataManagerCompany] = Field(None, alias='company')
    ...
    custom_fields: typing.Optional[EmployeeManagersAssignResponseDataManagerCustomFields] = Field(None, alias='customFields')
