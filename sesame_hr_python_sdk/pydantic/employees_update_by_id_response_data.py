...
from sesame_hr_python_sdk.pydantic.employees_update_by_id_response_data_company import EmployeesUpdateByIdResponseDataCompany
from sesame_hr_python_sdk.pydantic.employees_update_by_id_response_data_custom_fields import EmployeesUpdateByIdResponseDataCustomFields

class EmployeesUpdateByIdResponseData(BaseModel):
    ...
    company: typing.Optional[EmployeesUpdateByIdResponseDataCompany] = Field(None, alias='company')
    ...
    custom_fields: typing.Optional[EmployeesUpdateByIdResponseDataCustomFields] = Field(None, alias='customFields')
