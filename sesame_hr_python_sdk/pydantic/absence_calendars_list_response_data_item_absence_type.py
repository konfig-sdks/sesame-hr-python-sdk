...
from sesame_hr_python_sdk.pydantic.absence_calendars_list_response_data_item_absence_type_company import AbsenceCalendarsListResponseDataItemAbsenceTypeCompany

class AbsenceCalendarsListResponseDataItemAbsenceType(BaseModel):
    ...
    company: typing.Optional[AbsenceCalendarsListResponseDataItemAbsenceTypeCompany] = Field(None, alias='company')
