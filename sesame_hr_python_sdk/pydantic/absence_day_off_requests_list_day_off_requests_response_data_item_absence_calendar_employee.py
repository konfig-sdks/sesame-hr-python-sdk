...
from sesame_hr_python_sdk.pydantic.absence_day_off_requests_list_day_off_requests_response_data_item_absence_calendar_employee_company import AbsenceDayOffRequestsListDayOffRequestsResponseDataItemAbsenceCalendarEmployeeCompany
from sesame_hr_python_sdk.pydantic.absence_day_off_requests_list_day_off_requests_response_data_item_absence_calendar_employee_custom_fields import AbsenceDayOffRequestsListDayOffRequestsResponseDataItemAbsenceCalendarEmployeeCustomFields

class AbsenceDayOffRequestsListDayOffRequestsResponseDataItemAbsenceCalendarEmployee(BaseModel):
    ...
    company: typing.Optional[AbsenceDayOffRequestsListDayOffRequestsResponseDataItemAbsenceCalendarEmployeeCompany] = Field(None, alias='company')
    ...
    custom_fields: typing.Optional[AbsenceDayOffRequestsListDayOffRequestsResponseDataItemAbsenceCalendarEmployeeCustomFields] = Field(None, alias='customFields')
