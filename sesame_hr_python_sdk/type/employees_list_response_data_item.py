...
from sesame_hr_python_sdk.type.employees_list_response_data_item_company import EmployeesListResponseDataItemCompany
from sesame_hr_python_sdk.type.employees_list_response_data_item_custom_fields import EmployeesListResponseDataItemCustomFields

class RequiredEmployeesListResponseDataItem(TypedDict):
    pass

class OptionalEmployeesListResponseDataItem(TypedDict, total=False):
    ...
    company: EmployeesListResponseDataItemCompany
    ...
    customFields: EmployeesListResponseDataItemCustomFields
...
class EmployeesListResponseDataItem(RequiredEmployeesListResponseDataItem, OptionalEmployeesListResponseDataItem):
    pass
