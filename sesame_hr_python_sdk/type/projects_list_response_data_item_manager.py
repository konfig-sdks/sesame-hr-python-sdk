...
from sesame_hr_python_sdk.type.projects_list_response_data_item_manager_company import ProjectsListResponseDataItemManagerCompany
from sesame_hr_python_sdk.type.projects_list_response_data_item_manager_custom_fields import ProjectsListResponseDataItemManagerCustomFields

class RequiredProjectsListResponseDataItemManager(TypedDict):
    pass

class OptionalProjectsListResponseDataItemManager(TypedDict, total=False):
    ...
    company: ProjectsListResponseDataItemManagerCompany
    ...
    customFields: ProjectsListResponseDataItemManagerCustomFields
...
class ProjectsListResponseDataItemManager(RequiredProjectsListResponseDataItemManager, OptionalProjectsListResponseDataItemManager):
    pass
