...
from sesame_hr_python_sdk.type.employees_get_by_id_response_data_company import EmployeesGetByIdResponseDataCompany
from sesame_hr_python_sdk.type.employees_get_by_id_response_data_custom_fields import EmployeesGetByIdResponseDataCustomFields

class RequiredEmployeesGetByIdResponseData(TypedDict):
    pass

class OptionalEmployeesGetByIdResponseData(TypedDict, total=False):
    ...
    customFields: EmployeesGetByIdResponseDataCustomFields
...
class EmployeesGetByIdResponseData(RequiredEmployeesGetByIdResponseData, OptionalEmployeesGetByIdResponseData):
    pass
