...
from sesame_hr_python_sdk.type.work_entries_list_response_data_item_employee_company import WorkEntriesListResponseDataItemEmployeeCompany
from sesame_hr_python_sdk.type.work_entries_list_response_data_item_employee_custom_fields import WorkEntriesListResponseDataItemEmployeeCustomFields

class RequiredWorkEntriesListResponseDataItemEmployee(TypedDict):
    pass

class OptionalWorkEntriesListResponseDataItemEmployee(TypedDict, total=False):
    ...
    company: WorkEntriesListResponseDataItemEmployeeCompany
    ...
    customFields: WorkEntriesListResponseDataItemEmployeeCustomFields
...
class WorkEntriesListResponseDataItemEmployee(RequiredWorkEntriesListResponseDataItemEmployee, OptionalWorkEntriesListResponseDataItemEmployee):
    pass
