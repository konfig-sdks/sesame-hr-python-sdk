...
class RequiredRecruitmentUpdateCandidateRequest(TypedDict):
...
class OptionalRecruitmentUpdateCandidateRequest(TypedDict, total=False):
...
class RecruitmentUpdateCandidateRequest(RequiredRecruitmentUpdateCandidateRequest, OptionalRecruitmentUpdateCandidateRequest):
    pass
