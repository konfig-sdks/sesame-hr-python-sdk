...
from sesame_hr_python_sdk.type.employees_update_by_id_response_data_company import EmployeesUpdateByIdResponseDataCompany
from sesame_hr_python_sdk.type.employees_update_by_id_response_data_custom_fields import EmployeesUpdateByIdResponseDataCustomFields

class RequiredEmployeesUpdateByIdResponseData(TypedDict):
    pass

class OptionalEmployeesUpdateByIdResponseData(TypedDict, total=False):
    ...
    customFields: EmployeesUpdateByIdResponseDataCustomFields
...
class EmployeesUpdateByIdResponseData(RequiredEmployeesUpdateByIdResponseData, OptionalEmployeesUpdateByIdResponseData):
    pass
